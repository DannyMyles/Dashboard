        ...
        <div className="top_location">
          ...
          {countriesData.map((country) => (
            <div key={country.flag} className="donut_location">
              ...
              <div className="donut_location_color" style={{ backgroundColor: country.color }}>{country.color}</div>
            </div>
          ))}
        </div>
        <div className="top_location">
          ...
          {platformData.map((platform) => (
            <div key={platform.flag} className="donut_location">
              ...
              <div className="donut_location_color" style={{ backgroundColor: platform.backGroundColor }}>{platform.backGroundColor[0]}</div>
            </div>
          ))}
        </div>
      </div>
