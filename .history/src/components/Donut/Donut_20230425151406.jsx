        ...
        <div className="top_location">
          ...
          {countriesData.map((country) => (
            <div key={country.flag} className="donut_location">
              ...
              <div className="donut_location_color" style={{ backgroundColor: country.backgroundColor }}>he</div>
            </div>
          ))}
        </div>
        <div className="top_location">
          ...
          {platformData.map((platform) => (
            <div key={platform.flag} className="donut_location">
              ...
              <div className="donut_location_color" style={{ backgroundColor: platformData.backgroundColor }}>he</div>
            </div>
          ))}
        </div>
      </div>
