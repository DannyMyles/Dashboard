      ...
      <div className="donut_container">
        <div className="top_location">
          ...
          {countriesData.map((country) => (
            <div key={country.flag} className="donut_location" style={{ backgroundColor: country.backgroundColor }}>
        ...
        <div className="top_location">
          ...
          {platformData.map((platform) => (
            <div key={platform.flag} className="donut_location">
              ...
              <div className="donut_location_color">{platform.backGroundColor}</div>
            </div>
          ))}
        </div>
      </div>
